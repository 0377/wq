            ...
            <a class="feed-element" href="<?php  echo webUrl($plugin['identity'])?>" data-name="<?php  echo $plugin['name'];?>">
                ...
                <div class="media-body ">
                    <span class="title"><span class="fl"><?php  echo $plugin['name'];?><?php  if(in_array($plugin['identity'],$wxapp_array)) { ?></span><img
                            src="<?php  echo tomedia('../addons/ewei_shopv2/static/images/xcx.png')?>" alt="" data-placement="top" data-toggle="popover" data-trigger="hover" data-html="true" data-content="已支持小程序" style="font-size: 12px;color: #00c952;margin-left:5px"><?php  } ?><small class="text-muted"><?php  echo $plugin['desc'];?></small></span>
