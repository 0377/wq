            ...
            if ($message_type == TM_DIVIDEND_ORDER_FINISH && empty($usernotice['dividend_order_finish'])) {
                ...
                if($tm['is_advanced']){
                    ...
                    $message = array(
                        ...
                        'keyword1' => array('title' => '业务类型', 'value' => '会员通知', "color" => "#000000"),
                        'keyword2' => array('title' => '业务状态', 'value' => $set['texts']['dividend1'].'打款通知', "color" => "#000000"),
                ...
                $message = array(
                    ...
                    'keyword1' => array('title' => '业务类型', 'value' => '会员通知', "color" => "#000000"),
                    'keyword2' => array('title' => '业务状态', 'value' => '成为'.$set['texts']['agent'].'通知', "color" => "#000000"),
                    'keyword3' => array('title' => '业务内容', 'value' => '成为队长通知', "color" => "#000000"),
                    'remark' => array('value' => "\n感谢您的支持", "color" => "#000000")
                );
                $datas[] = array('name' => '昵称','value'=>$data['nickname']);
                $datas[] = array('name' => '时间','value'=>date('Y-m-d H:i:s', $data['headstime']));
                ...
                $message = array(
                    ...
                    'keyword1' => array('title' => '业务类型', 'value' => '会员通知', "color" => "#000000"),
                    'keyword2' => array('title' => '业务状态', 'value' => '已提交', "color" => "#000000"),
                    'keyword3' => array('title' => '业务内容', 'value' => "您的商城会员提交了一笔提现，\n金额:".$data['dividend']." \n 时间:".$time."\n 提现方式:".$data['type'], "color" => "#000000"),
                ...
                $message = array(
                    ...
                    'keyword1' => array('title' => '业务类型', 'value' => '会员通知', "color" => "#000000"),
                    'keyword2' => array('title' => '业务状态', 'value' => '团员成为队长通知', "color" => "#000000"),
                    'keyword3' => array('title' => '业务内容', 'value' => "您的团员在".$time."成为队长，他的下线不在为您提供分红", "color" => "#000000"),
                    'remark' => array('value' => "\n感谢您的支持", "color" => "#000000")
                );
