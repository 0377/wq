...
class Printset_EweiShopV2Page extends PluginWebPage {
   ...
   /* function test(){
        ...
        $data[1] = array('name' => '百世快递', 'express' => 'huitongkuaidi', 'code' => 'HTKY', 'datas' => serialize(array(array('style' => '二联180', 'spec' => '（宽100mm高180mm切点110/70）', 'size' => '180', 'isdefault' => 0), array('style' => '二联183', 'spec' => '（宽100mm 高183mm 切点87/5/91）', 'size' => '183', 'isdefault' => 1))));
        ...
        $data[9] = array('name' => '宅急送', 'express' => 'zhaijisong', 'code' => 'ZJS', 'datas' => serialize(array(array('style' => '二联120', 'spec' => '（宽100mm高116mm切点98/10）', 'size' => '120', 'isdefault' => 1))));
