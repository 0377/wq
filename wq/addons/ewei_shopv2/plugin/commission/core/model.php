            ...
            if ($message_type == TM_COMMISSION_AGENT_NEW && empty($usernotice['commission_agent_new'])) {
                ...
                if ($tm['is_advanced']) {
                    ...
                    $message = array(
                        ...
                        'keyword3' => array('title' => '业务内容', 'value' => '您新增了一个下级' . $data['nickname'], "color" => "#000000"),
                        'remark' => array('value' => "\n感谢您的支持", "color" => "#000000")
                    );
                    $toopenid = $openid;
                    ...
                    $msg = array(
                        'keyword1' => array('value' => '新增下级通知', "color" => "#73a68d"),
                ...
                if ($tm['is_advanced']) {
                    ...
                    $msg = array(
                        'keyword1' => array('value' => '下级付款通知', "color" => "#73a68d"),
                ...
                if ($tm['is_advanced']) {
                    ...
                    $msg = array(
                        'keyword1' => array('value' => '下级确认收货通知', "color" => "#73a68d"),
                ...
                if ($tm['is_advanced']) {
                    ...
                    $msg = array(
                        'keyword1' => array('value' => '提现申请提交通知', "color" => "#73a68d"),
                ...
                if ($tm['is_advanced']) {
                    ...
                    $msg = array(
                        'keyword1' => array('value' => '提现申请审核完成通知', "color" => "#73a68d"),
                ...
                if ($tm['is_advanced']) {
                    ...
                    $msg = array(
                        'keyword1' => array('value' => '佣金打款通知', "color" => "#73a68d"),
                ...
                if ($tm['is_advanced']) {
                    ...
                    $msg = array(
                        'keyword1' => array('value' => '分销商等级升级通知', "color" => "#73a68d"),
                ...
                if ($tm['is_advanced']) {
                    ...
                    $msg = array(
                        'keyword1' => array('value' => '成为分销商通知', "color" => "#73a68d"),
                        'keyword2' => array('value' => !empty($tm['commission_becometitle']) ? $tm['commission_becometitle'] : '恭喜您成为分销商', "color" => "#73a68d"),
                        'keyword3' => array('value' => $message, "color" => "#73a68d")
                    );
                ...
                if ($tm['is_advanced']) {
                    ...
                    $message = array(
                        ...
                        'keyword2' => array('title' => '业务状态', 'value' => '商户名称:' . $member['nickname'], "color" => "#000000"),
                        'keyword3' => array('title' => '业务内容', 'value' => '佣金提现:' . $data['commission'] . '元', "color" => "#000000"),
                        'remark' => array('value' => "\n感谢您的支持", "color" => "#000000")
                    );
                    $toopenid = $tm['openid'];
                    $datas[] = array('name' => '昵称', 'value' => $member['nickname']);
                    ...
                    $msg = array(
                        'keyword1' => array('value' => '分销商提现通知', "color" => "#73a68d"),
                        'keyword2' => array('value' => !empty($tm['commission_applymoneytitle']) ? $tm['commission_applymoneytitle'] : '您有分销商申请提现了', "color" => "#73a68d"),
